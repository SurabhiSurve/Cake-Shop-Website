...
<html lang="en-MU">
    <head>
        <meta charset="utf-8">
        <title>Sweet SHOP | ABOUT US</title>
            ...
            <div class="baker-info-container">
                <div class="baker-info-text">
                    ...
                    <div class="baker-name">
                        <span>Mis.Surabhi</span>
                    </div>
        
                    <div class="baker-description">
                        <p>“Desserts are truly one of the best kinds of food in the world. Cakes, whether chocolate or strawberry, are one of the most delicious. If you have pâtisserie marketing material, you must use adjectives to describe cake.…”</p>
                    </div>
                    ...
                    <div class="baker-position">
                        <span>CEO - KAKES Bakery Shop</span>
                    </div>
                </div>
            ...
            <div class="award-badge-container">
                <div class="award-badge-group">
                    <div class="badge badge1">
                        ...
                        <div class="badge-info">
                            ...
                            <span class="badge-date">2020-2021</span>
                            <p class="badge-description">My award winning skills I aim to provide clients with an individually tailored cake that is not only delectable.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="award-badge-group">
                    <div class="badge badge3">
                        ...
                        <div class="badge-info">
                            <span class="badge-title">BAKERY OF THE MONTH</span>
                            <span class="badge-date">2022-2023</span>
                            <p class="badge-description">My award winning skills I aim to provide clients with an individually tailored cake that is not only delectable.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="all-helper-info">
                <div class="helper-individual">
                    <div class="helper-group helper1">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Sahil Shinde</b></p>
                ...
                <div class="helper-individual">
                    <div class="helper-group helper2">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Surabhi Surve</b></p>
