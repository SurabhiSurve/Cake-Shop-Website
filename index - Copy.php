...
<html lang="en-MU">
    ...
    <body>
        ...
        <div class="slideshow-container">
            ...
            <div class="text">EVER      Y BATCH FROM SCRATCH</div>
            </div>
            ...
            <div class="all-helper-info-index">
                <div class="helper-individual-index">
                    <div class="helper-group helper0">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Mis.Surabhi Surve</b></p>
                            <p class="hierarchy">CEO - Shopkeeper</p>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper1">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>mr.Sahil Shinde </b></p>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper2">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Mis.Riya Raul</b></p>
